...
public class writePDF {
    ...
    public void writePN(int maphieu) {
        ...
        try {
            ...
            Paragraph paragraph1 = new Paragraph("Mã phiếu: PN-" + pn.getMaphieunhap(), fontNormal10);
            ...
            String Nhanvien = NhanVienDAO.getInstance().selectById(pn.getMaNV()).getHoten();
            Paragraph paragraph3 = new Paragraph("Nhân viên tạo: " + Nhanvien, fontNormal10); //thêm tên nhân viên sau khi import nhân viên
            ...
            table.setWidths(new float[]{40f, 15f, 20f, 15f, 30f});
            PdfPCell cell;

            table.addCell(new PdfPCell(new Phrase("Tên sản phẩm", fontBold15)));
            table.addCell(new PdfPCell(new Phrase("Size", fontBold15)));
            ...
            ArrayList<ChiTietPhieuNhapDTO> listpn = ChiTietPhieuNhapDAO.getInstance().selectAll(maphieu + "");
            System.out.println("mã" + listpn);
            //Truyen thong tin tung chi tiet vao table
            for (ChiTietPhieuNhapDTO ctp : listpn) {
    ...
    public void writePX(int maphieu) {
        ...
        try {
            ...
            Paragraph paragraph1 = new Paragraph("Mã phiếu: PX-" + px.getMaphieuxuat(), fontNormal10);
            ...
            String Nhanvien = NhanVienDAO.getInstance().selectById(px.getManv()).getHoten();
            //Paragraph paragraph3 = new Paragraph("Người thực hiện: " + ngtao, fontNormal10); // dùng sau khi import nhân viên
            Paragraph paragraph3 = new Paragraph("Nhân viên tạo: " + Nhanvien, fontNormal10);
            paragraph3.add(new Chunk(createWhiteSpace(5)));
            paragraph3.add(new Chunk("-"));
            paragraph3.add(new Chunk(createWhiteSpace(5)));
            paragraph3.add(new Chunk("Mã nhân viên: " + px.getManv(), fontNormal10)); // thêm mã nhân viên sau khi import nhân viên
